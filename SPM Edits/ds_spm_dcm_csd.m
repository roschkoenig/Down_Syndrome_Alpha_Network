function DCM = ds_spm_dcm_csd(DCM)
%==========================================================================
% RER Edit: call ds_spm_dcm_x_neural to free up all g parameters         
%==========================================================================
...
%--------------------------------------------------------------------------
%% RER Edit for Down Syndrome Data
[pE,pC]  = ds_spm_dcm_neural_priors(DCM.A,DCM.B,DCM.C,model);
...
%--------------------------------------------------------------------------
%% RER Edit for down syndrome data
[x,f]    = ds_spm_dcm_x_neural(pE,model); % spm_dcm_x_neural(pE,model);
 
% create DCM
%--------------------------------------------------------------------------
DCM.M.IS = 'spm_csd_mtf';
%% RR Edit for Down Syndrome Data
%--------------------------------------------------------------------------
DCM.M.FS = 'ds_spm_fs_csd';
...
%--------------------------------------------------------------------------
y     = ds_spm_fs_csd(DCM.xY.y,DCM.M);
for i = 1:length(y)
    n      = size(y{i},1);
